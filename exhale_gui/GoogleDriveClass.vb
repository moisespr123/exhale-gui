...
Public Class GoogleDriveClass
    ...
    Public Sub DownloadFile(ByVal Id As String, ByVal stream As FileStream)
        ...
        stream.Close()
    End Sub
    Public Sub DownloadFile(ByVal Id As String, ByVal stream As String)
        Dim getRequest As FilesResource.GetRequest = service.Files.Get(Id)
        Dim DownloadFile As New FileStream(stream, FileMode.Create)
        getRequest.Download(DownloadFile)
        DownloadFile.Close()
    End Sub
